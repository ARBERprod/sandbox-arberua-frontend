...
import { Slider, Slide } from '@/shared/ui/Slider';
...
import styles from './SubcategoryLabelsSlider.module.scss';

interface SubcategoryLabelsSliderProps {
  className?: string;
  slides: Slide[];
}

export const SubcategoryLabelsSlider = memo(({
  className,
  slides = [],
}:SubcategoryLabelsSliderProps) => {
