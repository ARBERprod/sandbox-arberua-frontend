...
import collectionsBannerMan from '@/shared/assets/images/collection-banner/new-collection-banner-man.webp';
import collectionsBannerWoman from '@/shared/assets/images/collection-banner/new-collection-banner-woman.webp';
